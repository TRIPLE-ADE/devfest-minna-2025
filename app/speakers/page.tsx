...
const SpeakersPage = () => {
  ...
  const speakers = [
    {
      ...
      fullBio:
        "Mudasiru is a seasoned DevOps Engineer and Google Developer Expert who specializes in building scalable ML infrastructure and MaaS solutions. With extensive experience in cloud technologies and AI deployment, he helps organizations leverage machine learning capabilities at scale.",
      ...
      website: "",
      sessionDescription:
        "Explore how to build and deploy Machine Learning as a Service using Google's Gemma models, covering inference optimization and scalable deployment strategies.",
    },
    {
      id: 2,
      ...
      website: "",
      sessionDescription:
        "As AI systems take on the role of writing, executing, and even evaluating tests, this session explores the ethical dimensions of AI in software testing, focusing on transparency, accountability, and fairness.",
    },
    {
      id: 3,
      ...
      sessionTitle:
        "Maximizing Your CPU to Scale Your Backend Vertically on Google Cloud Run",
      ...
      fullBio:
        "Software Engineer passionate about building and deploying scalable and reliable backend servers, with a passion for sharing practical insights on software architecture and API design. Gabriella specializes in cloud-native solutions and performance optimization.",
      track: "Web",
      level: "Intermediate",
      location: "Abuja, Nigeria",
      ...
      sessionDescription:
        "Explore how Node.js and Go approach CPU utilization differently, comparing single-threaded event loops vs goroutines for I/O heavy and CPU intensive workloads on Google Cloud Run.",
    },
    {
      id: 4,
      name: "Daniel Egbe",
      ...
      sessionTitle:
        "The New Renaissance: How AI is Democratizing Creativity in Tech",
      ...
      fullBio:
        "Daniel is a content writer turned video editor who creates engaging content for YouTube Shorts, Instagram Reels, and TikTok. With 5 years of experience, he works with international clients and prominent Nigerian creators, specializing in educational and productivity-driven content.",
      track: "AI & Machine Learning",
      level: "Introductory",
      ...
      sessionDescription:
        "Explore the intersection of AI and creativity, discussing how artificial intelligence is democratizing content creation, video editing, and design while examining the limitations and future of creative AI tools.",
    },
    {
      id: 5,
      ...
      website: "",
      sessionDescription:
        "Address the critical gap in product documentation within the Nigerian tech ecosystem, sharing strategies for creating comprehensive design documentation that helps teams build better products at scale.",
    },
    {
      id: 6,
      ...
      sessionTitle:
        "Escaping the Hustle Trap: Building a Tech Career Without a CS Background",
      ...
      fullBio:
        "Self-taught ICT specialist and technology advocate who transitioned from Counseling Psychology into software development, data science, and AI. Currently serves as Head of Management Information System at Abdulkadir Kure University, leading digital transformation initiatives.",
      track: "Others",
      level: "Introductory",
      ...
      website: "",
      sessionDescription:
        "Learn practical strategies for breaking into tech without a Computer Science degree, including leveraging free resources, building projects, and creating opportunities through skills and consistency.",
    },
    {
      id: 7,
      name: "Samuel Adeniyi",
      title: "CEO, Binarify",
      sessionTitle:
        "AI Without Code: Scaling Startups Through Intelligent Integrations",
      ...
      fullBio:
        "Samuel Adeniyi is the Co-Founder & CEO of Binarify, leading the development of Syncleon, an AI-powered no-code integration engine. With over six years of experience in software engineering and AI integration, he has delivered solutions across GovTech, AgricTech, and EdTech.",
      track: "AI & Machine Learning",
      level: "Introductory",
      location: "Minna, Niger State",
      ...
      sessionDescription:
        "Discover how no-code AI can help African startups scale faster through intelligent integrations, with practical examples and opportunities for developers to build and extend these solutions.",
    },
    {
      id: 8,
      name: "Muiz Aminu",
      ...
      fullBio:
        "Muiz Aminu is an Embedded Systems and Mobile App Developer who enjoys merging hardware and software to create smart, connected solutions. He designs end-to-end IoT projects using microcontrollers, cloud platforms, and Flutter for cross-platform apps.",
      track: "Mobile",
      level: "Introductory",
      location: "Minna, Niger State",
      ...
      website: "",
      sessionDescription:
        "Learn to build real-time IoT systems that collect sensor data and control actuators using Flutter and Firebase, covering ESP32 setup, database organization, and creating responsive dashboards.",
    },
  ];
  ...
  const tracks = useMemo(() => {
    const uniqueTracks = Array.from(
      new Set(
        speakers
          .map((speaker) => speaker.track)
          .filter((track) => track !== "Others"),
      ),
    );
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="relative">
              ...
              <h2 className="text-lg md:text-xl font-semibold mb-8 text-greyscale-dark/80">
                Learn from industry experts and thought leaders shaping the
                future of technology across Africa.
              </h2>
              ...
              <div className="grid grid-cols-3 gap-4 mt-8">
                <div className="text-center">
                  ...
                  <p className="text-sm text-greyscale-dark/80 font-semibold">
                    Speakers
                  </p>
                </div>
                <div className="text-center">
                    ...
                    {[...Array(2)].map((_, setIndex) => (
                      <div key={setIndex} className="flex flex-col gap-4">
                        {speakers.slice(0, 3).map((speaker) => (
                          <div
                            key={`up-${speaker.id}-${setIndex}`}
                            className="relative rounded-3xl overflow-hidden border-4 border-accent-yellow shadow-lg"
                          >
                            <Image
                              src={speaker.image}
                              alt={speaker.name}
            ...
            {filteredSpeakers.map((speaker) => (
              ...
              >
                ...
                <div className="relative h-80 overflow-hidden">
                  ...
                  {/* Track Badge */}
                  <div
                    className={`absolute top-4 left-4 px-3 py-1 rounded-full text-xs font-bold ${trackColors[speaker.track as keyof typeof trackColors] || trackColors.Others}`}
                  >
                    {speaker.track}
                  </div>
                  ...
                  {/* Level Badge */}
                  <div
                    className={`absolute top-4 right-4 px-3 py-1 rounded-full text-xs font-bold ${levelColors[speaker.level as keyof typeof levelColors] || levelColors["Introductory"]}`}
                  >
                    {speaker.level}
                  </div>
                </div>
      ...
      <section className="bg-white py-16">
        <div className="container mx-auto px-4 lg:px-8 xl:px-12 text-center">
          ...
          <p className="text-xl font-semibold text-greyscale-dark/80 mb-8 max-w-2xl mx-auto">
            Join us at DevFest Minna 2025 and network with these amazing
            speakers and the tech community.
          </p>
          <Link
            href="/get-dp"
