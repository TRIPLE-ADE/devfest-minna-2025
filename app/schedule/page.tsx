        ...
        <div className='mt-3 grid grid-cols-1 gap-6 px-4'>
          <div className='card'>
            ...
            <div className='h-48 w-full my-2 px-6 bg-white'>
              ...
              <h2 className='text-xl sm:text-2xl font-bold my-1 break-words'>
                Welcome Address & Keynote
              </h2>
              <h4 className='text-md font-quicksand sm:text-lg font-bold break-words'>
                Umar Saidu
              </h4>
            </div>
            <div className='h-55 sm:h-50 w-full my-2 px-6 bg-white'>
              ...
              <h2 className='text-xl sm:text-2xl font-bold my-1 break-words'>
                Ethics in AI-driven Testing: who tests the tester?
              </h2>
           <h4 className='text-md font-quicksand sm:text-lg font-bold break-words'>
                Temidayo Akintoye
              </h4>
            ...
            <div className='h-65 sm:h-50 w-full my-2 px-6 bg-white'>
              ...
              <h2 className='text-xl sm:text-2xl font-bold my-1 break-words'>
                Maximizing Your CPU to Scale Your Backend Vertically on Google
                cloud run
              </h2>
              <h4 className='text-md font-quicksand sm:text-lg font-bold break-words'>
                Gabriella Amaefule
            ...
            <div className='h-57 sm:h-50 w-full my-2 px-6 bg-white'>
              ...
              <h2 className='text-xl sm:text-2xl font-bold my-1 break-words'>
                Building Better Experiences Through Product Documentation
              </h2>
              <h4 className='text-md font-quicksand sm:text-lg font-bold break-words'>
                Fauziya Mohammed
              </h4>
            ...
            <div className='h-65 sm:h-50 w-full my-2 px-6 bg-white'>
              ...
              <h2 className='text-xl sm:text-2xl font-bold my-1 break-words'>
                Escaping the Hustle Trap: Building a Tech Career Without a
            ...
            <div className='h-65 sm:h-50 w-full my-2 px-6 bg-white'>
              ...
              <h2 className='text-xl sm:text-2xl font-bold my-1 break-words'>
                AI Without Code: Scaling Startups and Empowering Developers
            ...
            <div className='h-65 sm:h-50 w-full my-2 px-6 bg-white'>
              ...
              <h2 className='text-xl sm:text-2xl font-bold my-1 break-words'>
                Developing Bidirectional IoT with Flutter and Firebase from
                Sensor Data to Device Control.
              </h2>
              <h4 className='text-md font-quicksand sm:text-lg font-bold break-words'>
                Muiz Aminu
              </h4>
            ...
            <div className='h-50 w-full my-2 px-6 bg-white'>
              ...
              <h2 className='text-xl sm:text-2xl font-bold my-1 break-words'>
                Gemma: Inferences and building a MaaS
              </h2>
              <h4 className='text-md font-quicksand sm:text-lg font-bold break-words'>
            ...
            <div className='h-53 w-full my-2 px-6 bg-white'>
              ...
              <h2 className='text-2xl font-bold my-5'>
                Break, Pictures & Visit to Sponsors Stand
              </h2>
            </div>
            <div className='h-47 w-full my-2 px-6 bg-white'>
              <Button className='my-5 w-25 h-10 bg-green-600'>
