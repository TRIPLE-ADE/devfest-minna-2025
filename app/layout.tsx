...
export const metadata: Metadata = {
  ...
  description:
    "Join DevFest Minna 2025 on November 8th at Rasheedat Restaurant, Minna. A community-led developer festival featuring expert speakers, hands-on workshops, and networking opportunities. Free registration for all skill levels.",
  keywords: [
    "DevFest",
    "DevFest Minna",
    "DevFest 2025",
  ...
  twitter: {
    ...
    title: "DevFest Minna 2025 | Google Developer Festival",
    description:
      "Join DevFest Minna 2025 on November 8th at Rasheedat Restaurant, Minna. Free tech conference with expert speakers and workshops.",
  ...
  other: {
    ...
    "event:location":
      "Rasheedat Restaurant, Shehu Kangiwa Road, Minna, Niger State, Nigeria",
