...
export default function Header() {
  ...
  return (
    <div className='w-full font-sans flex-nowrap flex flex-col lg:flex-row lg:items-center px-4 lg:px-24 py-4 justify-between bg-background'>
      <div className='flex flex-row items-center justify-between w-full'>
        {/* Logo left */}
        <Link
          href='/'
          className='flex-shrink-0 flex-row flex items-center overflow-hidden'
        >
          <Image
      ...
      <div className='hidden lg:block'>
        <div className='flex flex-row gap-5 lg:w-auto lg:h-auto lg:bg-transparent lg:relative lg:items-center lg:gap-10 pr-10'>
          <ul className='flex flex-row items-center gap-10 font-medium text-lg overflow-x-auto text-black whitespace-nowrap'>
            <li>
              <Link href='/get-dp' className='text-black whitespace-nowrap'>
                Get DP
              </Link>
            </li>
            <li>
      ...
      <div>
        <Link
          ...
          className='rounded-full  text-black border border-solid border-transparent transition-colors flex items-center justify-center bg-accent-orange gap-2 hover:bg-[#383838] dark:hover:bg-[#ccc] font-medium text-sm sm:text-base h-10 sm:h-12 px-4 sm:px-5 sm:w-auto'
        >
          Register
        </Link>
      </div>
